...
public class Receiver_HelloWorld implements Runnable {
        ...
        try {
            ...
            Consumer consumer = new DefaultConsumer(channel) {
                ...
                public void handleDelivery(String consumerTag, Envelope envelope,
                    ...
                    // Is here that is make the send to consumers

                    //Emitter.send(receivedMsg, "10.180.43.174");
                    //Emitter.send(receivedMsg, "10.180.43.174");
                }
            };
    ...
    public static void main(String[] args) {
        new Thread(new Receiver_HelloWorld()).start();
    }
